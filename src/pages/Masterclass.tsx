  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <Button
        ...
        onClick={() => signIn("/masterclass", "google")}
        disabled={loading}
      >
      ...
      <Button
        size="sm"
        variant="outline"
        className="gap-2 text-xs font-medium bg-foreground text-background hover:bg-foreground/90 hover:text-background border-foreground"
        onClick={() => signIn("/masterclass", "apple")}
        disabled={loading}
      >
