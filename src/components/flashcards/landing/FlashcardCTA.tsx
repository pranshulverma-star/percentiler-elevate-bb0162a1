  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onStart}
          className="w-full sm:w-auto px-10 py-3 sm:py-3.5 rounded-xl text-base font-semibold active:scale-[0.97] transition-transform"
          style={{ background: "white", color: "hsl(24,100%,50%)" }}
        >
          Start Practicing — Free
        </button>
        <p className="text-white/60 text-xs sm:text-sm mt-3 sm:mt-4">No credit card. No commitment. Just learning.</p>
      </div>
    </section>
  );
}
